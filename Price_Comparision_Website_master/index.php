...
/*"&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off&as-pos=1&as-type=HISTORY";
*/
$flp_query=$flp_str1.$searchtext.$flp_str2;

$html = file_get_html($flp_query);

echo $html->find('div[class="fMghEO"]',0)->plaintext;
echo "<span class='float-right'>";
echo $html->find('div[class="_30jeq3 _1_WHN1"]',0)->plaintext;
echo "</span><br><br>";

echo $html->find('div[class="col col-7-12"]',1)->plaintext;
echo "<span class='float-right'>";
echo $html->find('div[class="_30jeq3 _1_WHN1"]',1)->plaintext;
echo "</span><br><br>";

echo $html->find('div[class="col col-7-12"]',2)->plaintext;
echo "<span class='float-right'>";
